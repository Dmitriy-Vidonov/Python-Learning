...
# В принципе, name можно просто сделать общим полем, не обязательно его уточнять для конкретных типов.
# Определения классов делаются отдельно от исполнимого кода, в самом начале программы, а всё, что работает,
# уже следом за ними. Не смешивай с кодом ни определения классов, ни определения функций.
